...
<body>
	...
	<H1 class="header" align="center"> THE BEST PRODUCER OF SLATE IN KAZAKHSTAN</H1>
	<div class="our">
		<div>
	...
	<div class="mis">
		<div>
			<H1 class="inmis" align="center">Mission and values</H1>
		</div>
	</div>
	<div class="body">
		<h3 style="font-family: 'Roboto Slab', serif; color: gold;">Mission:</h3>
		<h4 style="font-family: 'Raleway', sans-serif; color: #FFFFFF;">Create comfortable conditions of life of customers by using high quality eco-friendly building materials at affordable prices</h4>

		<h3 style="font-family: 'Roboto Slab', serif; color: gold;">Values:</h3>
		<ol class="rounded">
	...
	<?php
			if(!isset($_GET['action'])) {
				...
				$actionCheck = $_GET['action'];
				if ($actionCheck == "signup"){
					echo "<script>alert('You have signed up successfully.')</script>";
					exit();
				}
				elseif ($actionCheck == "login"){
					echo "<script>alert('You have logged in successfully.')</script>";
					exit();
				}
				elseif ($actionCheck == "orderit"){
					echo "<script>alert('All your goods will be ready within three working days. Come to us to pick up your order. Payment after receipt of the goods. Thank you!')</script>";
					exit();
				}
			}
		?>	
